...
const ContactPage = ({ data }) => {
  ...
  return (
    <Layout>
      <Seo title="Contact" />
      <div className="page no-hero page-center">
        <section className="page-section content-wrapper">
          <AccentHeader>{page_title.text}</AccentHeader>
        </section>
        ...
        <section className="page-section content-wrapper">
          <h2 className="form-title text-center">{form_title.text}</h2>
          ...
          <div className="contact-details">
            {email_address && (
              <ContactDetails
                ...
                value={email_address}
                icon={<RiMailOpenLine className="icon" />}
              />
            )}
            {email_address_2 && (
              <ContactDetails
            ...
            {phone_number && (
              <ContactDetails
                ...
                value={phone_number}
                icon={<TiPhoneOutline className="icon" />}
              />
            )}
            {phone_number_2 && (
              <ContactDetails
...
export const ContactDetails = ({ label, value, icon, as }) => (
  <div className="contact-detail-group">
    ...
    {as === "link" ? (
      ...
      <div className="contact-detail">{value}</div>
    )}
  </div>
)
